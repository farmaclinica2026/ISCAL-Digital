        ...
        <table className="w-full divide-y divide-gray-200 table-auto">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="w-2/6 px-4 py-3.5 text-left text-xs font-extrabold text-gray-500 uppercase tracking-wider">
                Cirurgia
              </th>
              <th scope="col" className="w-2/6 px-4 py-3.5 text-left text-xs font-bold text-indigo-900 uppercase tracking-wider bg-indigo-50/50 border-x border-indigo-100/60">
                Antibiótico
              </th>
              {/* Colunas restantes com largura automática */}
              <th scope="col" className="px-4 py-3.5 text-left text-xs font-extrabold text-gray-500 uppercase tracking-wider">
                Indução
              </th>
              <th scope="col" className="px-4 py-3.5 text-left text-xs font-extrabold text-gray-500 uppercase tracking-wider">
                Intra-Op
              </th>
              <th scope="col" className="px-4 py-3.5 text-left text-xs font-bold text-blue-900 uppercase tracking-wider bg-blue-100/40 border-l border-blue-200/60">
                Duração
              </th>
              <th scope="col" className="px-4 py-3.5 text-left text-xs font-bold text-blue-900 uppercase tracking-wider bg-blue-100/40 border-l border-blue-200/60">
                Pós-Op/Intervalo
            ...
            {protocols.map((protocol) => {
              ...
              return (
                <tr key={protocol.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className={`px-4 py-4 align-top break-words border-x border-indigo-100/40 ${isNoAntibiotic ? 'bg-gray-50/50' : 'bg-indigo-50/10'}`}>
                    <span className={`text-[14px] leading-relaxed ${isNoAntibiotic ? 'text-gray-400 italic font-medium' : 'text-indigo-950 font-bold'}`}>
                      {protocol.antibiotic}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-4 align-top text-slate-900 font-semibold bg-blue-50/50 border-l border-blue-100">
                    {protocol.duration}
                  </td>
                  <td className="px-4 py-4 align-top text-slate-900 font-semibold bg-blue-50/50 border-l border-blue-100">
